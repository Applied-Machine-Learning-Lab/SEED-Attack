...
def main(args):
    ...
    if args.few_shot:
        input_file = './raw_solution_modified_q_CoT_few_shot/' + dataset + '/' + llm_name + '/' + 'solution.jsonl'
        output_path = './final_solution_modified_q_CoT_few_shot/' + dataset + '/' + llm_name + '/'
        output_file = './final_solution_modified_q_CoT_few_shot/' + dataset + '/' + llm_name + '/' + 'ratio_' + str(args.ratio) + '_reasoning_steps.jsonl'

    else:
        input_file = './raw_solution_modified_q_CoT/' + dataset + '/' + llm_name + '/' + 'solution.jsonl'
        output_path = './final_solution_modified_q_CoT/' + dataset + '/' + llm_name + '/'
        output_file = './final_solution_modified_q_CoT/' + dataset + '/' + llm_name + '/' + 'ratio_' + str(args.ratio) + '_reasoning_steps.jsonl'
