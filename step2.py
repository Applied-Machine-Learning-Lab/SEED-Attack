...
def run(args):
    ...
    if args.few_shot:
        ...
        output_file = './v2_2/raw_solution_modified_q_CoT_few_shot/' + dataset + '/' + llm_name + '/' + 'solution.jsonl'
    else:
        output_path = './v2_2/raw_solution_modified_q_CoT/' + dataset + '/' + llm_name + '/'
        output_file = './v2_2/raw_solution_modified_q_CoT/' + dataset + '/' + llm_name + '/' + 'solution.jsonl'
